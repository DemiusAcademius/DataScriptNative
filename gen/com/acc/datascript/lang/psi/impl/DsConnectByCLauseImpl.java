...
public class DsConnectByCLauseImpl extends ASTWrapperPsiElement implements DsConnectByCLause {

  public DsConnectByCLauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DsVisitor) ((DsVisitor)visitor).visitConnectByCLause(this);
