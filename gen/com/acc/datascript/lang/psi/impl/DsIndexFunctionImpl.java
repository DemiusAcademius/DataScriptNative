...
public class DsIndexFunctionImpl extends ASTWrapperPsiElement implements DsIndexFunction {

  public DsIndexFunctionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DsVisitor) ((DsVisitor)visitor).visitIndexFunction(this);
