...
public class DsSelectDerivedColumnImpl extends ASTWrapperPsiElement implements DsSelectDerivedColumn {

  public DsSelectDerivedColumnImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DsVisitor) ((DsVisitor)visitor).visitSelectDerivedColumn(this);
