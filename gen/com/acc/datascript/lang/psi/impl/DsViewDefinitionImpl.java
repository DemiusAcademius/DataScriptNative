...
public class DsViewDefinitionImpl extends ASTWrapperPsiElement implements DsViewDefinition {

  public DsViewDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DsVisitor) ((DsVisitor)visitor).visitViewDefinition(this);
